...
- Replace `<button>` in HTML message with innerHTML instead of remove
  [#1125](https://github.com/nextgen-networks/snappymail/issues/1125)
- Mailvelope failed
  [#1126](https://github.com/nextgen-networks/snappymail/issues/1126)
- Tabs labels row height
- Selecting not yet existing filter throws error message instead of opening edit box
  [#1104](https://github.com/nextgen-networks/snappymail/issues/1104)
- JavaScript Squire `node is null` error
- Config/Application.php: array_rand(): Argument
  [#1](https://github.com/nextgen-networks/snappymail/issues/1) cannot be empty
  [#1123](https://github.com/nextgen-networks/snappymail/issues/1123)
- Pressing Enter in Add Filter dialog results in "Leave page?" prompt
  [#1112](https://github.com/nextgen-networks/snappymail/issues/1112)
- Issue with certain Amazon emails
  [#1086](https://github.com/nextgen-networks/snappymail/issues/1086)
- HTML font 8px and 10px issue
  [#1082](https://github.com/nextgen-networks/snappymail/issues/1082)
- Exception when executed on command line on the first-time
  [#1085](https://github.com/nextgen-networks/snappymail/issues/1085)
- Folders missing pagination
  [#1070](https://github.com/nextgen-networks/snappymail/issues/1070)
- Nextcloud WYSIWYG button style
  [#1138](https://github.com/nextgen-networks/snappymail/issues/1138)
- Nextcloud .btn-group > .btn layout
- Nextcloud Bulleted items do not show the bullets in the preview window.
  [#1117](https://github.com/nextgen-networks/snappymail/issues/1117)
- Nextcloud Contacts integration
  [#1083](https://github.com/nextgen-networks/snappymail/issues/1083)
...
- Hard coded string "Message body is empty"
  [#1048](https://github.com/nextgen-networks/snappymail/issues/1048)
- Split SPAM label in user.json for directory and action
  [#1065](https://github.com/nextgen-networks/snappymail/issues/1065)
- A solution for
  [#1056](https://github.com/nextgen-networks/snappymail/issues/1056) to support dates in different language/calendar
...
- Workaround Upgrade with Nextcloud stuck in Maintenance mode
  [#1046](https://github.com/nextgen-networks/snappymail/issues/1046)
- Use Actions()->decodeRawKey()
- French language updated
  [#1045](https://github.com/nextgen-networks/snappymail/pull/1045) by @hguilbert
- Sorting in folders not working
  [#1022](https://github.com/nextgen-networks/snappymail/issues/1022)
...
- Clear folder link should be hidden if "dangerous actions" is not active
  [#1037](https://github.com/nextgen-networks/snappymail/issues/1037)
- 500 error generating preview with GD2
  [#1009](https://github.com/nextgen-networks/snappymail/issues/1009)
- Text and Links Jumping While Writing
  [#1004](https://github.com/nextgen-networks/snappymail/issues/1004)
- Odd annoying behaviour when copy/ pasting anything into an email and then attempting to edit it.
  [#1054](https://github.com/nextgen-networks/snappymail/issues/1054)
- Check if $rImapLiteralStream is open resource and not closed
- Save as eml to nextcloud not working anymore
  [#1057](https://github.com/nextgen-networks/snappymail/issues/1057)
- AuthError and Call to a member function ImapConnectAndLogin() on null
  [#1060](https://github.com/nextgen-networks/snappymail/issues/1060)
- Thread count missing/shown
  [#1003](https://github.com/nextgen-networks/snappymail/issues/1003)
...
- authentication with smtp freenet.de
  [#1038](https://github.com/nextgen-networks/snappymail/issues/1038)
...
- Cache issue with index
  [#1024](https://github.com/nextgen-networks/snappymail/issues/1024)
...
- Better design for .accountPlace text
  [#1025](https://github.com/nextgen-networks/snappymail/issues/1025)

### Fixed
- Reply is broken
  [#1027](https://github.com/nextgen-networks/snappymail/issues/1027)
- Endless loop at login - Cannot assign array to property MailSo\Imap\Folder::$MAILBOXID
  [#1032](https://github.com/nextgen-networks/snappymail/issues/1032)
...
- Unique attachments.zip filename
  [#992](https://github.com/nextgen-networks/snappymail/issues/992)
- Select next email after (re)move current
  [#968](https://github.com/nextgen-networks/snappymail/issues/968)

### Changed
- Improved FolderCollection handling
- MODSEQ requires 64-bit int
- Update russian language
  [#994](https://github.com/nextgen-networks/snappymail/pull/994) by @Akrobs
...
- Show message toolbar on screens > 1400px
  [#970](https://github.com/nextgen-networks/snappymail/issues/970)
- Chinese updated
  [#1011](https://github.com/nextgen-networks/snappymail/pull/1011) by @mayswind
...
- Image in Signature disappears in Sent/Draft
  [#932](https://github.com/nextgen-networks/snappymail/issues/932)
- Mail list is empty
  [#998](https://github.com/nextgen-networks/snappymail/issues/998)
- Cache handling issues
  [#1003](https://github.com/nextgen-networks/snappymail/issues/1003)
- No message notification popup when installed in sub-directory
  [#1007](https://github.com/nextgen-networks/snappymail/issues/1007)
- ERROR: Undefined constant "MailSo\Log\Drivers\STDERR"
  [#965](https://github.com/nextgen-networks/snappymail/issues/965)
- 'Location:' headers using proper '302 Found' header
- Can't send email
  [#1006](https://github.com/nextgen-networks/snappymail/issues/1006)
- Attachment preview
  [#1005](https://github.com/nextgen-networks/snappymail/issues/1005)
...
- SnappyMail Menu under Nextcloud top bar
  [#1017](https://github.com/nextgen-networks/snappymail/issues/1017)
...
- Add CSP frame-ancestors for
  [#537](https://github.com/nextgen-networks/snappymail/issues/537)

### Changed
- Reduce/simplify CSS footprint
- Use the System/Browser font by default
  [#988](https://github.com/nextgen-networks/snappymail/pull/988) by @HeySora
...
- After page refreshes in background whilst editing a draft, the space bar stops working
  [#860](https://github.com/nextgen-networks/snappymail/issues/860)
- Updated Portuguese
  [#984](https://github.com/nextgen-networks/snappymail/pull/984) by @ner00
- Updated French
  [#985](https://github.com/nextgen-networks/snappymail/pull/985) by @hguilbert

### Fixed
- unset border-box for message body
  [#990](https://github.com/nextgen-networks/snappymail/issues/990)
- Unread email count badge shows -1
  [#989](https://github.com/nextgen-networks/snappymail/issues/989)
- unicode mailto: addresses not decoded
- Unicode email/url address matching
  [#955](https://github.com/nextgen-networks/snappymail/issues/955)
...
- Nextcloud File picker doesn't insert multiple links
  [#981](https://github.com/nextgen-networks/snappymail/issues/981)
- Call to protected method RainLoop\Enumerations\UploadError::getUserMessage()
  [#982](https://github.com/nextgen-networks/snappymail/issues/982)
- Issue with the top logo and text of a certain e-mail
  [#953](https://github.com/nextgen-networks/snappymail/issues/953)
- Facebook logo missing from emails sent out by it
  [#954](https://github.com/nextgen-networks/snappymail/issues/954)
...
- Show error when trying to send empty message
  [#974](https://github.com/nextgen-networks/snappymail/issues/974)
- max_sys_loadavg as setting
  [#971](https://github.com/nextgen-networks/snappymail/issues/971)
...
- Remove SVG elements properly from messages
  [#972](https://github.com/nextgen-networks/snappymail/issues/972)
- Sending large HTML messages slow/fail
  [#962](https://github.com/nextgen-networks/snappymail/issues/962)
- Nextcloud login failed
  [#969](https://github.com/nextgen-networks/snappymail/issues/969)
- DoMessageList() hash check was incorrect
- "Move to folder" button overlays folder sidebar on mobile
  [#961](https://github.com/nextgen-networks/snappymail/issues/961)
- Spanish translation SPAM and NOT SPAM strings are reversed
  [#964](https://github.com/nextgen-networks/snappymail/issues/964)
- Can't open Thunderbird PGP keys from decrypted message
  [#958](https://github.com/nextgen-networks/snappymail/issues/958)
- Can't close Sieve dialog
  [#960](https://github.com/nextgen-networks/snappymail/issues/960)
...
- Workaround "server connection error"
  [#936](https://github.com/nextgen-networks/snappymail/issues/936)
- Cleanup AbstractViewPopup handling
- Italian translation
  [#948](https://github.com/nextgen-networks/snappymail/pull/948) by @lota
- Replace Element.fromHTML() with createElement()

### Fixed
- New subfolder not visible
  [#937](https://github.com/nextgen-networks/snappymail/issues/937)
...
- Cannot open messages that have an email address without an @ in the From header
  [#950](https://github.com/nextgen-networks/snappymail/issues/950)
...
- Whitelist advanced SPF/DKIM/DMARC valid feature
  [#938](https://github.com/nextgen-networks/snappymail/issues/938)
...
- Issue with themes and Chrome cache
  [#188](https://github.com/nextgen-networks/snappymail/issues/188)
- Settings panel width due to display:flex
  [#940](https://github.com/nextgen-networks/snappymail/issues/940)
- Not respecting default theme setting
  [#941](https://github.com/nextgen-networks/snappymail/issues/941)
- Some files had 0755 instead of 0644
- Some spacing between message "view images" buttons for
  [#201](https://github.com/nextgen-networks/snappymail/issues/201)
- Whitelist failed when empty or when using `:`
  [#938](https://github.com/nextgen-networks/snappymail/issues/938)
- Cosmetics of the external images whitelist menu
  [#939](https://github.com/nextgen-networks/snappymail/issues/939)
...
- qq.com not supporting literal-string in search
  [#836](https://github.com/nextgen-networks/snappymail/issues/836)
...
### Added
- New dark themes
  [#925](https://github.com/nextgen-networks/snappymail/pull/925) by @TheCuteFoxxy
...
- pt-PT translation by @ner00
  [#917](https://github.com/nextgen-networks/snappymail/issues/917) and
  [#920](https://github.com/nextgen-networks/snappymail/issues/920)
- fr-FR translation by @hguilbert
  [#919](https://github.com/nextgen-networks/snappymail/issues/919)
- Layout section rl-right now is `display: flex` and solves
  [#928](https://github.com/nextgen-networks/snappymail/issues/928)
- Some Themes background to `cover`
  [#918](https://github.com/nextgen-networks/snappymail/issues/918)
...
- Undefined index: cid
  [#921](https://github.com/nextgen-networks/snappymail/issues/921)
- On upgrade prevent Apache access errors for
  [#358](https://github.com/nextgen-networks/snappymail/issues/358)
- Import contacts as CSV is broken
  [#931](https://github.com/nextgen-networks/snappymail/issues/931)

### Removed
- Blockquote height calculator for
  [#902](https://github.com/nextgen-networks/snappymail/issues/902)
...
- message maximum quoted text level for speed.
  [#902](https://github.com/nextgen-networks/snappymail/issues/902)
- LoveDark Theme
  [#913](https://github.com/nextgen-networks/snappymail/pull/913) by @TheCuteFoxxy
...
- Prevent plugin property decrypt error
  [#859](https://github.com/nextgen-networks/snappymail/issues/859)
- Index.html cache issue
  [#891](https://github.com/nextgen-networks/snappymail/issues/891)
- Images whitelist regular expression failed
  [#201](https://github.com/nextgen-networks/snappymail/issues/201)
- Undefined index: ShowImages
  [#901](https://github.com/nextgen-networks/snappymail/issues/901)
- Chrome shows LSep boxes in certain emails
  [#900](https://github.com/nextgen-networks/snappymail/issues/900)
- Don't remember OpenPGP/GnuPGP key passphrase when it fails
  [#840](https://github.com/nextgen-networks/snappymail/issues/840)
...
- Refresh frequency of the mailboxes
  [#486](https://github.com/nextgen-networks/snappymail/issues/486)
- Temporarily save password for private key during session
  [#840](https://github.com/nextgen-networks/snappymail/issues/840)
- Upgrade from Rainloop, password not migrated
  [#898](https://github.com/nextgen-networks/snappymail/issues/898)
- Whitelist to show images directly
  [#201](https://github.com/nextgen-networks/snappymail/issues/201)
- HTML editor paste image makes it max 1024px width/height
  [#262](https://github.com/nextgen-networks/snappymail/issues/262)
...
- Update nb-NO language
  [#896](https://github.com/nextgen-networks/snappymail/pull/896) by @master3395
...
- Two issues with images being delivered via ProxyExternal
  [#887](https://github.com/nextgen-networks/snappymail/issues/887)
- Multiple accounts conflicts when using multiple tabs
  [#892](https://github.com/nextgen-networks/snappymail/issues/892)
- Spaces in attached file names are not preserved
  [#893](https://github.com/nextgen-networks/snappymail/issues/893)
- Prevent empty area scroll on body

### Removed
- Floating HTML text formatting menu on mobile
  [#828](https://github.com/nextgen-networks/snappymail/issues/828)
...
- Nextcloud move themes outside of app folder
  [#875](https://github.com/nextgen-networks/snappymail/issues/875)
- Add check to unregister system addressbook
  [#879](https://github.com/nextgen-networks/snappymail/pull/879) by @akhil1508
...
- Nextcloud workaround upgrade OPCache issue
  [#880](https://github.com/nextgen-networks/snappymail/issues/880)
- SMTP error while using PHP mail()
  [#884](https://github.com/nextgen-networks/snappymail/issues/884)
- Cannot create folder
  [#885](https://github.com/nextgen-networks/snappymail/issues/885)
- Image stretching when image hasd max-width
  [#869](https://github.com/nextgen-networks/snappymail/issues/869)
...
- Right margin to folder search input wrapper
  [#871](https://github.com/nextgen-networks/snappymail/pull/871) by @codiflow
...
- CardDAV sync error - Request aborted
  [#866](https://github.com/nextgen-networks/snappymail/issues/866)
- PDF not possible to be viewed in the browser
  [#867](https://github.com/nextgen-networks/snappymail/issues/867)
- ZIP Files cannot be uploaded from Desktop to attachments (other files can be uploaded)
  [#878](https://github.com/nextgen-networks/snappymail/issues/878)
...
- A button to clear folder search input field
  [#847](https://github.com/nextgen-networks/snappymail/pull/847) by @codiflow
- Preparations for custom SMTP credentials handling for
  [#859](https://github.com/nextgen-networks/snappymail/issues/859)
  [#458](https://github.com/nextgen-networks/snappymail/issues/458)
  [#431](https://github.com/nextgen-networks/snappymail/issues/431)
  [#233](https://github.com/nextgen-networks/snappymail/issues/233)

### Changed
- Display the time of emails, not just the size and date
  [#843](https://github.com/nextgen-networks/snappymail/issues/843)
- Made thread number a bit wider
  [#844](https://github.com/nextgen-networks/snappymail/issues/844)
- Improved contacts suggestions limit handling
  [#849](https://github.com/nextgen-networks/snappymail/issues/849)
- 64-bit PHP was required
  [#852](https://github.com/nextgen-networks/snappymail/issues/852)
- Update fr-FR translations
  [#854](https://github.com/nextgen-networks/snappymail/pull/854) by @dominiquefournier
...
- LiteSpeed does not disable compression although .htaccess says so
  [#525](https://github.com/nextgen-networks/snappymail/issues/525)
  [#855](https://github.com/nextgen-networks/snappymail/issues/855)
- "Move to folder" functionality displays in desktop view when on mobile
  [#858](https://github.com/nextgen-networks/snappymail/issues/858)
...
- Nextcloud failed loading app data when path didn't end with /
  [#864](https://github.com/nextgen-networks/snappymail/issues/864)
- Workaround Nextcloud session_start issue
  [#813](https://github.com/nextgen-networks/snappymail/issues/813)
...
- NC integration app metadata: add links to admin and dev docs
  [#820](https://github.com/nextgen-networks/snappymail/pull/820) by @p-bo
- Clicking on messagelist grouped date/from searches on that date/from
  [#815](https://github.com/nextgen-networks/snappymail/issues/815)
- Nextcloud Improved file picker layout
  [#825](https://github.com/nextgen-networks/snappymail/issues/825)
...
- Added DAV path error to log for
  [#822](https://github.com/nextgen-networks/snappymail/issues/822)
- Resolve layout issues by changing from `fixed` to `relative`
  [#686](https://github.com/nextgen-networks/snappymail/issues/686)
- Cache handling of messagelist changed due to etag issues
- Improve german and italian translation
  [#846](https://github.com/nextgen-networks/snappymail/pull/846) by @cm-schl

### Fixed
- Searching on Nextcloud search
  [#787](https://github.com/nextgen-networks/snappymail/issues/787)
- Workaround another Nextcloud disallowed .htaccess
  [#790](https://github.com/nextgen-networks/snappymail/issues/790)
- Compact display of folders in nextcloud
  [#824](https://github.com/nextgen-networks/snappymail/pull/824) by @makoehr
...
- Unable to change font/text colour when composing message using Safari
  [#826](https://github.com/nextgen-networks/snappymail/issues/826)
- auth_logging failed
  [#489](https://github.com/nextgen-networks/snappymail/issues/489)
- Class "RainLoop\Actions\Notifications" not found
  [#839](https://github.com/nextgen-networks/snappymail/issues/839)
...
- A lot of MessageList sorting improvements
  [#796](https://github.com/nextgen-networks/snappymail/issues/796)
...
- F5 and Ctrl-F5 reload logs out of Snappymail in Chrome.
  [#800](https://github.com/nextgen-networks/snappymail/issues/800)
- Switching accounts does not work anymore with 2.24.2
  [#802](https://github.com/nextgen-networks/snappymail/issues/802)
...
- Disable sorting when viewing message thread
  [#445](https://github.com/nextgen-networks/snappymail/issues/445)
- Update Chinese translation
  [#794](https://github.com/nextgen-networks/snappymail/pull/794) by @mayswind
...
- Deleting message fails with message "Cannot move message" on hMailServer
  [#793](https://github.com/nextgen-networks/snappymail/issues/793)
...
- Custom page login not working for first time due to smctoken security
  [#798](https://github.com/nextgen-networks/snappymail/issues/798)
- Message list is always empty due to wrong implementation of RFC 8474
  [#799](https://github.com/nextgen-networks/snappymail/issues/799)
...
- Make MessageList per day optional
  [#737](https://github.com/nextgen-networks/snappymail/issues/737)

### Fixed
- Typed property MailSo\Cache\Drivers\Redis::$sKeyPrefix must not be accessed before initialization
  [#792](https://github.com/nextgen-networks/snappymail/issues/792)
- Attachments in mails in 2.24 not loading in reply/forward
  [#789](https://github.com/nextgen-networks/snappymail/issues/789)
- Rollback #280 due to complications
  [#280](https://github.com/nextgen-networks/snappymail/issues/280)
...
- Check SMTP SIZE
  [#779](https://github.com/nextgen-networks/snappymail/issues/779)
...
- Invalid Attachments (PDF)
  [#466](https://github.com/nextgen-networks/snappymail/issues/466)
- Email HTML images rendering issue
  [#564](https://github.com/nextgen-networks/snappymail/issues/564)
- "Server message: No supported SASL mechanism found, remote server wants:" in hMailServer
  [#780](https://github.com/nextgen-networks/snappymail/issues/780)
...
- Added the new imapsync.php command line script for
  [#744](https://github.com/nextgen-networks/snappymail/issues/744)
- Added manual setting for 12/24h clock
  [#760](https://github.com/nextgen-networks/snappymail/issues/760)
- Add options to mark the message I'm viewing as unread and return to the inbox
  [#766](https://github.com/nextgen-networks/snappymail/issues/766)

### Fixed
- Extension menu shows only some available extensions
  [#778](https://github.com/nextgen-networks/snappymail/issues/778)
- New solution for [#423](https://github.com/nextgen-networks/snappymail/issues/423) due to [#774](https://github.com/nextgen-networks/snappymail/issues/774)
- Avatars extension error on smartphone
  [#764](https://github.com/nextgen-networks/snappymail/issues/764)
...
- Show the number of unread mails on all mail addresses/accounts
  [#437](https://github.com/nextgen-networks/snappymail/issues/437)
- Show OpenSSL version in Admin => About

### Changed
- Redirect to login page instead of "invalid token" popup
  [#752](https://github.com/nextgen-networks/snappymail/issues/752)
...
- Loosing HTML signature in account identity under settings
  [#750](https://github.com/nextgen-networks/snappymail/issues/750)
- Plugin configuration did not load anymore when type was SELECTION
  [#753](https://github.com/nextgen-networks/snappymail/pull/753) by @cm-schl
- Nextcloud Default theme shows gray text on gray background
  [#754](https://github.com/nextgen-networks/snappymail/issues/754)
- Only run JSON hooks when $sAction is set
  [#755](https://github.com/nextgen-networks/snappymail/issues/755)
- Unsupported SASL mechanism OAUTHBEARER
  [#756](https://github.com/nextgen-networks/snappymail/issues/756)
  [#758](https://github.com/nextgen-networks/snappymail/issues/758)
  [#759](https://github.com/nextgen-networks/snappymail/issues/759)
...
- Scroll bar with the mobile version in "Advanced search" screen
  [#712](https://github.com/nextgen-networks/snappymail/issues/712)
...
- Attempt to solve #745 in v2.22.6 failed and resulted in errors #746 and #748
  [#745](https://github.com/nextgen-networks/snappymail/issues/745)
  [#746](https://github.com/nextgen-networks/snappymail/issues/746)
  [#748](https://github.com/nextgen-networks/snappymail/issues/748)
...
- PluginProperty DefaultValue contained array while it should not
  [#741](https://github.com/nextgen-networks/snappymail/issues/741)
...
- ZIP Download multiple emails
  [#717](https://github.com/nextgen-networks/snappymail/issues/717)
...
- "Remember me" failed due to v2.22.4 Session token change
  [#719](https://github.com/nextgen-networks/snappymail/issues/719)
  [#731](https://github.com/nextgen-networks/snappymail/issues/731)

### Removed
- Vacation filter: Button to add recipients (+)
  [#728](https://github.com/nextgen-networks/snappymail/issues/728)
...
- Session token is related to the user agent string
  [#713](https://github.com/nextgen-networks/snappymail/issues/713)
- Better browser cache handling for avatars plugin
  [#714](https://github.com/nextgen-networks/snappymail/issues/714)
- Force HTML editor when set as default when replying to message
  [#355](https://github.com/nextgen-networks/snappymail/issues/355)

### Fixed
- Contact Error - object Object
  [#716](https://github.com/nextgen-networks/snappymail/issues/716)
- Unable to move messages to different folder by drag and drop
  [#710](https://github.com/nextgen-networks/snappymail/issues/710)
- v2.22.3 unknown error
  [#709https://github.com/nextgen-networks/snappymail/issues/709)
...
- Improved cPanel integration
  [#697](https://github.com/nextgen-networks/snappymail/issues/697)
- Update to OpenPGP.js v5.5.0

### Fixed
- drag & drop folder expansion
  [#707](https://github.com/nextgen-networks/snappymail/issues/707)
- Save selected messages as .eml in Nextcloud failed
  [#704](https://github.com/nextgen-networks/snappymail/issues/704)
...
- AddressBookInterface::GetContactByEmail() to support sender image/avatar extension
  [#115](https://github.com/nextgen-networks/snappymail/issues/115)

### Changed
- All the attachment zone is not clickable, even if the cursor is a hand
  [#691](https://github.com/nextgen-networks/snappymail/issues/691)
- Different approach for "update button duplicated in admin panel"
  [#677](https://github.com/nextgen-networks/snappymail/issues/677)
- Better drag & drop solution for leftPanel

### Fixed
- The page does not change after batch deletion
  [#684](https://github.com/nextgen-networks/snappymail/issues/684)
- Prevent domain uppercase issues found in
  [#689](https://github.com/nextgen-networks/snappymail/issues/689)
- Login invalid response: VXNlcm5hbWU6CG
  [#693](https://github.com/nextgen-networks/snappymail/issues/693)
...
- Download all Attachments of selected Emails
  [#361](https://github.com/nextgen-networks/snappymail/issues/361)

### Changed
- Log current shortcuts scope for
  [#690](https://github.com/nextgen-networks/snappymail/issues/690)
...
- Also show From email address by default
  [#683](https://github.com/nextgen-networks/snappymail/issues/683)
...
- Unable to separate runtime from installation
  [#685](https://github.com/nextgen-networks/snappymail/issues/685)
...
- Increase visible reading area for small screens
  [#672](https://github.com/nextgen-networks/snappymail/issues/672)
...
- Message responsive resizing width/height of elements
  [#678](https://github.com/nextgen-networks/snappymail/issues/678)
- Focus on textarea when creating a new plain text email
  [#501](https://github.com/nextgen-networks/snappymail/issues/501)
- CardDav remove photos of my contacts when synchronizing
  [#679](https://github.com/nextgen-networks/snappymail/issues/679)
...
- Firefox < 98 dialogs
  [#673](https://github.com/nextgen-networks/snappymail/issues/673)

## 2.21.2 – 2022-11-15

### Added
- Allow browser Spellchecker
  [#574](https://github.com/nextgen-networks/snappymail/issues/574)
- Decode MIME charset of .EML attachments
  [#662](https://github.com/nextgen-networks/snappymail/issues/662)

### Changed
- Increase message visible text area
  [#672](https://github.com/nextgen-networks/snappymail/issues/672)
- When copy/paste image use the raw data instead of clipboard HTML
  [#654](https://github.com/nextgen-networks/snappymail/issues/654)
...
- Workaround Nextcloud calendar crashes
  [#622](https://github.com/nextgen-networks/snappymail/issues/622)
  [#661](https://github.com/nextgen-networks/snappymail/issues/661)
- Added share public/internal file link
  [#569](https://github.com/nextgen-networks/snappymail/issues/569)
...
- Crypt crashes when Sodium not installed
  [#641](https://github.com/nextgen-networks/snappymail/issues/641)
  [#657](https://github.com/nextgen-networks/snappymail/issues/657)
  [#663](https://github.com/nextgen-networks/snappymail/issues/663)
  [#664](https://github.com/nextgen-networks/snappymail/issues/664)
  [#668](https://github.com/nextgen-networks/snappymail/issues/668)
  [#669](https://github.com/nextgen-networks/snappymail/issues/669)
- Personalised favicon not working - default Snappymail favicon showing
  [#665](https://github.com/nextgen-networks/snappymail/issues/665)

### Nextcloud
- v23 ContentSecurityPolicy versions issue
  [#666](https://github.com/nextgen-networks/snappymail/issues/666)
...
- Allow setting additional Sec-Fetch rules, as discussed by
  [#585](https://github.com/nextgen-networks/snappymail/issues/585)
- Light/Dark favicon.svg
  [#643](https://github.com/nextgen-networks/snappymail/issues/643)
- Allow an account name/label
  [#571](https://github.com/nextgen-networks/snappymail/issues/571)
...
- Removed message double-click to full screen
  [#638](https://github.com/nextgen-networks/snappymail/issues/638)

### Fixed
- ldap-identities-plugin
  [#647](https://github.com/nextgen-networks/snappymail/pull/647) by @cm-schl
...
### Fixed
- ?admin login failed
  [#642](https://github.com/nextgen-networks/snappymail/issues/642)
...
- Improved workaround for Nextcloud Content-Security-Policy bug
  Safari [#631](https://github.com/nextgen-networks/snappymail/issues/631)
  Edge [#633](https://github.com/nextgen-networks/snappymail/issues/633)
...
- Throw decrypt errors
  [#632](https://github.com/nextgen-networks/snappymail/issues/632)
...
- Cookie “name” has been rejected because it is already expired.
  [#636](https://github.com/nextgen-networks/snappymail/issues/636)
- Content-Security-Policy 'strict-dynamic' was missing

### Nextcloud
- Better handling of Content-Security-Policy
  [#631](https://github.com/nextgen-networks/snappymail/issues/631)
  [#633](https://github.com/nextgen-networks/snappymail/issues/633)
- Nextcloud 23 Error Call to undefined method useStrictDynamic()
  [#634](https://github.com/nextgen-networks/snappymail/issues/634)
- Use snappymail icon as favicon-mask.svg instead default nextcloud logo
  [#635](https://github.com/nextgen-networks/snappymail/issues/635)
...
- Add more search operators (i.e. copy lots of Gmail ones)
  [#625](https://github.com/nextgen-networks/snappymail/issues/625)
...
- Shift + F in search bar resulted in forwarding message
  [#624](https://github.com/nextgen-networks/snappymail/issues/624)

### Nextcloud
- auto login mechanism not working anymore
  [#627](https://github.com/nextgen-networks/snappymail/issues/627)
...
- Solve Nextcloud 25 CSS issues
  [#620](https://github.com/nextgen-networks/snappymail/issues/620)
- PutinICS does is not working for all calendar events
  [#622](https://github.com/nextgen-networks/snappymail/issues/622)
- Update readme
  [#617](https://github.com/nextgen-networks/snappymail/pull/617) by @cm-schl
...
- Disable Nextcloud Impersonate check due to login/logout complications
  [#561](https://github.com/nextgen-networks/snappymail/issues/561)
...
- PGP Decryption / Encryption Failures
  [#600](https://github.com/nextgen-networks/snappymail/issues/600)
- Undefined constant "OCA\SnappyMail\Util\RAINLOOP_APP_LIBRARIES_PATH
  [#601](https://github.com/nextgen-networks/snappymail/issues/601)
- Cannot access admin panel
  [#602](https://github.com/nextgen-networks/snappymail/issues/602)
- Wont show my emails
  [#604](https://github.com/nextgen-networks/snappymail/issues/604)
- Return type of MailSo\Base\StreamFilters\LineEndings::filter
  [#610](https://github.com/nextgen-networks/snappymail/issues/610)
...
- Filter scripts UI let user understand which filter is active
  [#590](https://github.com/nextgen-networks/snappymail/issues/590)
