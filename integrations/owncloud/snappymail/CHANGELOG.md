...
- A lot of MessageList sorting improvements
  [#796](https://github.com/nextgen-networks/snappymail/pull/796)
...
- Workaround Nextcloud disallowed .htaccess
  [#790](https://github.com/nextgen-networks/snappymail/pull/790)
- Searching on Nextcloud search failed
  [#787](https://github.com/nextgen-networks/snappymail/pull/787)
...
- F5 and Ctrl-F5 reload logs out of Snappymail in Chrome.
  [#800](https://github.com/nextgen-networks/snappymail/pull/800)
- Switching accounts does not work anymore with 2.24.2
  [#802](https://github.com/nextgen-networks/snappymail/pull/802)
...
- Disable sorting when viewing message thread
  [#445](https://github.com/nextgen-networks/snappymail/pull/445)
- Update Chinese translation by @mayswind
  [#794](https://github.com/nextgen-networks/snappymail/pull/794)
...
- Deleting message fails with message "Cannot move message" on hMailServer
  [#793](https://github.com/nextgen-networks/snappymail/pull/793)
...
- Custom page login not working for first time due to smctoken security
  [#798](https://github.com/nextgen-networks/snappymail/pull/798)
- Message list is always empty due to wrong implementation of RFC 8474
  [#799](https://github.com/nextgen-networks/snappymail/pull/799)
...
- Make MessageList per day optional
  [#737](https://github.com/nextgen-networks/snappymail/pull/737)

### Fixed
- Typed property MailSo\Cache\Drivers\Redis::$sKeyPrefix must not be accessed before initialization #792
  [#792](https://github.com/nextgen-networks/snappymail/pull/792)
- Attachments in mails in 2.24 not loading in reply/forward #789
  [#789](https://github.com/nextgen-networks/snappymail/pull/789)
- Rollback #280 due to complications
  [#280](https://github.com/nextgen-networks/snappymail/pull/280)
...
- Check SMTP SIZE
  [#779](https://github.com/nextgen-networks/snappymail/pull/779)
...
- Invalid Attachments (PDF)
  [#466](https://github.com/nextgen-networks/snappymail/pull/466)
- Email HTML images rendering issue
  [#564](https://github.com/nextgen-networks/snappymail/pull/564)
- "Server message: No supported SASL mechanism found, remote server wants:" in hMailServer
  [#780](https://github.com/nextgen-networks/snappymail/pull/780)
...
- Added the new imapsync.php command line script for
  [#744](https://github.com/nextgen-networks/snappymail/pull/744)
- Added manual setting for 12/24h clock
  [#760](https://github.com/nextgen-networks/snappymail/pull/760)
...
- New solution for [#423](https://github.com/nextgen-networks/snappymail/pull/423) due to [#774](https://github.com/nextgen-networks/snappymail/pull/774)
- Avatars extension error on smartphone
  [#764](https://github.com/nextgen-networks/snappymail/pull/764)
...
- Show the number of unread mails on all mail addresses/accounts
  [#437](https://github.com/nextgen-networks/snappymail/pull/437)
- Show OpenSSL version in Admin => About

### Changed
- Redirect to login page instead of "invalid token" popup
  [#752](https://github.com/nextgen-networks/snappymail/pull/752)
...
- Loosing HTML signature in account identity under settings
  [#750](https://github.com/nextgen-networks/snappymail/pull/750)
- Plugin configuration did not load anymore when type was SELECTION by @cm-schl
  [#753](https://github.com/nextgen-networks/snappymail/pull/753)
- Nextcloud Default theme shows gray text on gray background
  [#754](https://github.com/nextgen-networks/snappymail/pull/754)
- Only run JSON hooks when $sAction is set
  [#755](https://github.com/nextgen-networks/snappymail/pull/755)
- Unsupported SASL mechanism OAUTHBEARER
  [#756](https://github.com/nextgen-networks/snappymail/pull/756)
  [#758](https://github.com/nextgen-networks/snappymail/pull/758)
  [#759](https://github.com/nextgen-networks/snappymail/pull/759)
...
- Scroll bar with the mobile version in "Advanced search" screen
  [#712](https://github.com/nextgen-networks/snappymail/pull/712)
...
- Attempt to solve #745 in v2.22.6 failed and resulted in errors #746 and #748
  [#745](https://github.com/nextgen-networks/snappymail/pull/745)
  [#746](https://github.com/nextgen-networks/snappymail/pull/746)
  [#748](https://github.com/nextgen-networks/snappymail/pull/748)
...
- PluginProperty DefaultValue contained array while it should not
  [#741](https://github.com/nextgen-networks/snappymail/pull/741)
...
- ZIP Download multiple emails
  [#717](https://github.com/nextgen-networks/snappymail/pull/717)
...
- "Remember me" failed due to v2.22.4 Session token change
  [#719](https://github.com/nextgen-networks/snappymail/pull/719)
  [#731](https://github.com/nextgen-networks/snappymail/pull/731)

### Removed
- Vacation filter: Button to add recipients (+)
  [#728](https://github.com/nextgen-networks/snappymail/pull/728)
...
- Session token is related to the user agent string
  [#713](https://github.com/nextgen-networks/snappymail/pull/713)
- Better browser cache handling for avatars plugin
  [#714](https://github.com/nextgen-networks/snappymail/pull/714)
- Force HTML editor when set as default when replying to message
  [#355](https://github.com/nextgen-networks/snappymail/pull/355)

### Fixed
- Contact Error - object Object
  [#716](https://github.com/nextgen-networks/snappymail/pull/716)
- Unable to move messages to different folder by drag and drop
  [#710](https://github.com/nextgen-networks/snappymail/pull/710)
- v2.22.3 unknown error
  [#709https://github.com/nextgen-networks/snappymail/pull/709)
...
- Improved cPanel integration
  [#697](https://github.com/nextgen-networks/snappymail/pull/697)
- Update to OpenPGP.js v5.5.0

### Fixed
- drag & drop folder expansion
  [#707](https://github.com/nextgen-networks/snappymail/pull/707)
- Save selected messages as .eml in Nextcloud failed
  [#704](https://github.com/nextgen-networks/snappymail/pull/704)
...
- AddressBookInterface::GetContactByEmail() to support sender image/avatar extension
  [#115](https://github.com/nextgen-networks/snappymail/pull/115)

### Changed
- All the attachment zone is not clickable, even if the cursor is a hand
  [#691](https://github.com/nextgen-networks/snappymail/pull/691)
- Different approach for "update button duplicated in admin panel"
  [#677](https://github.com/nextgen-networks/snappymail/pull/677)
- Better drag & drop solution for leftPanel

### Fixed
- The page does not change after batch deletion
  [#684](https://github.com/nextgen-networks/snappymail/pull/684)
- Prevent domain uppercase issues found in
  [#689](https://github.com/nextgen-networks/snappymail/pull/689)
- Login invalid response: VXNlcm5hbWU6CG
  [#693](https://github.com/nextgen-networks/snappymail/pull/693)
...
- Download all Attachments of selected Emails
  [#361](https://github.com/nextgen-networks/snappymail/pull/361)

### Changed
- Log current shortcuts scope for
  [#690](https://github.com/nextgen-networks/snappymail/pull/690)
...
- Also show From email address by default
  [#683](https://github.com/nextgen-networks/snappymail/pull/683)
...
- Mobile View on cellphones: automatic scrolling not working near the visual keyboard
  [#686](https://github.com/nextgen-networks/snappymail/pull/686)
- Unable to separate runtime from installation
  [#685](https://github.com/nextgen-networks/snappymail/pull/685)
...
- Increase visible reading area for small screens
  [#672](https://github.com/nextgen-networks/snappymail/pull/672)
...
- Message responsive resizing width/height of elements
  [#678](https://github.com/nextgen-networks/snappymail/pull/678)
- Focus on textarea when creating a new plain text email
  [#501](https://github.com/nextgen-networks/snappymail/pull/501)
- CardDav remove photos of my contacts when synchronizing
  [#679](https://github.com/nextgen-networks/snappymail/pull/679)
...
- Firefox < 98 dialogs
  [#673](https://github.com/nextgen-networks/snappymail/pull/673)

## 2.21.2 – 2022-11-15

### Added
- Allow browser Spellchecker
  [#574](https://github.com/nextgen-networks/snappymail/pull/574)
- Decode MIME charset of .EML attachments
  [#662](https://github.com/nextgen-networks/snappymail/pull/662)

### Changed
- Increase message visible text area
  [#672](https://github.com/nextgen-networks/snappymail/pull/672)
- When copy/paste image use the raw data instead of clipboard HTML
  [#654](https://github.com/nextgen-networks/snappymail/pull/654)
...
- Workaround Nextcloud calendar crashes
  [#622](https://github.com/nextgen-networks/snappymail/pull/622)
  [#661](https://github.com/nextgen-networks/snappymail/pull/661)
- Added share public/internal file link
  [#569](https://github.com/nextgen-networks/snappymail/pull/569)
...
- Crypt crashes when Sodium not installed
  [#641](https://github.com/nextgen-networks/snappymail/pull/641)
  [#657](https://github.com/nextgen-networks/snappymail/pull/657)
  [#663](https://github.com/nextgen-networks/snappymail/pull/663)
  [#664](https://github.com/nextgen-networks/snappymail/pull/664)
  [#668](https://github.com/nextgen-networks/snappymail/pull/668)
  [#669](https://github.com/nextgen-networks/snappymail/pull/669)
- Personalised favicon not working - default Snappymail favicon showing
  [#665](https://github.com/nextgen-networks/snappymail/pull/665)

### Nextcloud
- v23 ContentSecurityPolicy versions issue
  [#666](https://github.com/nextgen-networks/snappymail/pull/666)
...
- Allow setting additional Sec-Fetch rules, as discussed by
  [#585](https://github.com/nextgen-networks/snappymail/pull/585)
- Light/Dark favicon.svg
  [#643](https://github.com/nextgen-networks/snappymail/pull/643)
- Allow an account name/label
  [#571](https://github.com/nextgen-networks/snappymail/pull/571)
...
- Removed message double-click to full screen
  [#638](https://github.com/nextgen-networks/snappymail/pull/638)

### Fixed
- ldap-identities-plugin by @cm-schl
  [#647](https://github.com/nextgen-networks/snappymail/pull/647)
...
### Fixed
- ?admin login failed
  [#642](https://github.com/nextgen-networks/snappymail/pull/642)
...
- Update readme by @cm-schl
  [#617](https://github.com/nextgen-networks/snappymail/issues/617)
